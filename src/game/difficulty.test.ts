...
describe('speedMultiplier', () => {
  it('parte da 1 (nessun livello salito)', () => {
    expect(speedMultiplier(0)).toBe(1)
  })
  it('cresce a ogni livello (×1.2 di default)', () => {
  ...
  it('factorPerLevel 1 = difficoltà costante', () => {
    expect(speedMultiplier(50, { factorPerLevel: 1, cap: 8 })).toBe(1)
  })
})

describe('difficultyTick', () => {
  it('accelera il tick salendo di livello', () => {
